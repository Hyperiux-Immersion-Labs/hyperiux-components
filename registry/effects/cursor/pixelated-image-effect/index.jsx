...
export default function PixelatedImageEffect({
  ...
  priority = true,
  imageClassName = "",
  heading = "Move cursor left in the image block for a clear image, right for more pixelation.",
}) {
  ...
  return (
    <div className="relative flex h-dvh w-dvw flex-col gap-15 items-center justify-center">
      ...
      <h2 className="text-5xl text-center max-lg:hidden w-[75%]">
        {heading}
      </h2>

      <h2 className="hidden max-lg:block text-center text-2xl">
        {heading}
      ...
      <div
        ref={imageRef}
        className="relative h-[55vh] w-full max-md:max-w-[90%] overflow-hidden max-lg:max-w-[90%] max-w-lg touch-none"
