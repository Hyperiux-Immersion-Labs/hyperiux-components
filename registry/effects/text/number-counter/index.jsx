...
export default function NumberCounter() {
 ...
 <h2 className="text-[3vw] max-xl:text-[4vw] max-md:text-[7vw] text-[#111111] text-center">
 Numbers That Speak for Themselves
 </h2>

 <div className="w-full flex flex-col xl:flex-row items-stretch justify-center max-xl:items-center gap-8">
 <div className="flex-1 min-w-65 rounded-md border border-black/10 bg-white shadow-sm p-8 flex flex-col items-center max-xl:w-fit">
 ...
 className="mt-6 px-5 py-2 rounded-full bg-[#111111] text-white text-sm max-md:text-sm max-xl:text-lg cursor-pointer"
 >
 Replay
 </button>
 </div>

 <div className="flex-1 min-w-[260px] rounded-md border border-black/10 bg-white shadow-sm p-8 flex flex-col items-center max-xl:w-fit">
 <div className="flex-1 w-full flex items-center justify-center">
 <NumberCounterTwo
 key={replayTwoKey}
 value="594"
 textSize="text-[5vw] max-xl:text-[7vw] max-md:text-[12vw] md:text-[3.2vw]"
 color="#021A54"
 fontWeight="normal"
 />
 </div>
 ...
 className="mt-6 px-5 py-2 max-md:text-sm max-xl:text-lg rounded-full bg-[#111111] text-white text-sm cursor-pointer"
 >
 Replay
 </button>
 </div>
