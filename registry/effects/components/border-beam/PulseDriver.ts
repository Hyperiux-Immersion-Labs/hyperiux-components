 ...
 *
 * @param config - config from getPulseDriverConfig() in styles.js
 * @returns cleanup function that unregisters the instance (and
 *          stops the shared loop once no instances remain).
 */
