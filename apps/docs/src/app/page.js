    ...
    <HomeLoader>
      <div className="min-h-screen">
          ...
          <div className="max-w-5xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl border border-border/60/20 bg-dark-card">
                ...
                >
                  No npm packages to install. Just copy the code directly into
                  your project. You own the code.
                </p>
              </div>
              ...
              <div className="p-8 rounded-2xl border border-border/60/20 bg-dark-card">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.5" }}
                >
                  Use our CLI to add effects automatically. Handles dependencies
                  and places files in the right location.
                </p>
              </div>
              ...
              <div className="p-8 rounded-2xl border border-border/60/20 bg-dark-card">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.5" }}
                >
                  Every effect is fully customizable. Adjust props, tweak
                  styles, make it yours.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white py-24">
          <div className="max-w-5xl mx-auto px-4">
            <h2
              className="font-display text-5xl font-normal mb-12 text-center text-foreground"
            ...
            <div className="max-w-2xl mx-auto space-y-8">
              <div className="flex gap-5">
                ...
                <div className="flex-1">
                  <h3 className="font-sans font-semibold text-lg mb-3 text-foreground">
                    Initialize Hyperiux
                  </h3>
...
<BlurText>Hello World</BlurText>`}</pre>
        ...
        <section className="bg-dark-surface text-white py-24">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <h2
              className="font-display text-5xl md:text-6xl font-normal mb-6"
