import { FileEncryption as EncryptionMarquee } from "@/components/FileEncryption/FileEncryption";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 mb-16 text-center px-4">
        ...
        <h1 className="font-mono text-[#ff5f00]! font-black text-5xl md:text-6xl tracking-tight">
          CARD VAULT
        </h1>
